...
export default function Home() {
  const {user} = UserAuth()
  return (
    <main id="home" className=' flex flex-col justify-center items-center p-24'>
      <h1 className=" text-5xl text-center font-bold pt-16 pb-5">Welcome to Vrukshaa - Your Go-To Plant Health Expert!</h1>
