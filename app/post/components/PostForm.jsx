    ...
    return (
        <div>
            <form className=' flex flex-col justify-center items-center w-full'>
                ...
                <div onClick={() => { imageUpload.current.click() }} className=' w-11/12 py-12 rounded-lg cursor-pointer bg-green-500 hover:bg-green-300 flex justify-center items-center text-3xl transition-all font-bold'>
                ...
                <div className={`${!submit && '-translate-y-full'} transition-all w-full h-full flex justify-center items-center bg-green-300 fixed top-0 right-0`} style={{ transitionDuration: "500ms" }}>
